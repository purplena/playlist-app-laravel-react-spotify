...
<p>Open the <code>.env</code> file and update the following values:</p>

<ul>
  <li>
    <strong>APP_URL</strong><br />
    Set this to the local address of your Codespace or development environment.
  </li>
  <li>
    <strong>Spotify OAuth (optional)</strong><br />
    If you plan to use Spotify authentication, provide:
    <ul>
      <li><code>SPOTIFY_CLIENT_ID</code></li>
      <li><code>SPOTIFY_CLIENT_SECRET</code></li>
    </ul>
    Generate credentials via the
    <a href="https://developer.spotify.com/dashboard" target="_blank">
      Spotify Developer Dashboard
    </a>.
  </li>
  <li>
    <strong>Google OAuth (optional)</strong><br />
    To enable Google authentication, provide:
    <ul>
  ...
  <li>
    ...
    Update your database credentials according to the settings defined in
...
<h3>5. Set Storage Permissions</h3>

<p>Ensure Laravel has write access to the storage directory:</p>

<pre><code>chmod o+w ./storage/ -R</code></pre>

<h3>6. Create Storage Symlink</h3>
...
<pre><code>php artisan serve --host=0.0.0.0</code></pre>
